...
if (!isset($_GET['domain']) || !preg_match('/^(https?:)\/\/((nullchan7msxi257|nullchpl673e6jo3|nullplctggmjazqcoboc2pw5anogckczzj6xo45ukrnsaxarpswu7sid)\.onion|0chan\.(hk|xyz|pl)|ochan\.ru)/', $_GET['domain'], $matches))
