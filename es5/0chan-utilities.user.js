...
var darkMode = {
  ...
  init: function init() {
    ...
    var userSettings = LSfetchJSON('userSettings'),
      nativeSupport = typeof (userSettings === null || userSettings === void 0 ? void 0 : userSettings.isDark) !== 'undefined',
      settings = LSfetchJSON('ZU-settings'),
      on = nativeSupport ? userSettings.isDark : settings && settings.darkMode !== undefined ? settings.darkMode : this.enabledByDefault;
    if (!nativeSupport && on) {
      this.toggle(on, false);
    }
    if (on && settings !== null && settings !== void 0 && settings.liquidAss) {
  ...
  toggle: function toggle() {
    ...
    if (on) injector.inject('ZU-dark', this.css);else {
  ...
  toggleLiquidAss: function toggleLiquidAss(on) {
    console.log('toggle liqeuid ass', on);
    if (!this.liquidCSS) {
      this.liquidCSS = GM_getResourceText("liquidCSS");
    }
    if (on) injector.inject('ZU-liquid', this.liquidCSS);else injector.remove('ZU-liquid');
  }
};
...
var boardHider = {
  ...
  refresh: function refresh() {
    ...
    if (typeof ((_LSfetchJSON = LSfetchJSON('userSettings')) === null || _LSfetchJSON === void 0 ? void 0 : _LSfetchJSON.hiddenBoards) !== 'undefined') {
