...
var eventDispatcher = {
  click: function click(e) {
    ...
    if (e.path.find(function (el) {
      ...
      return el.classList && (el.classList.contains('ZU-settings-dropdown') || el.classList.contains('ZU-prevent-settings-dropdown-close'));
    })) {
    ...
    var eat = e.path.find(function (el) {
      return el.classList && el.classList.contains('ZU-enter-autohide-top');
    });
    if (eat) {
    ...
    var ret = e.path.find(function (el) {
      return el.classList && el.classList.contains('ZU-exit-autohide-top');
    });
    if (ret) {
    ...
    var hba = e.path.find(function (el) {
      return el.classList && el.classList.contains('ZU-hide-attachment');
    });
    if (hba) {
    ...
    var rae = e.path.find(function (el) {
      return el.classList && el.classList.contains('ZU-remove-autohide-entry');
    });
    if (rae) {
    ...
    var rbg = e.path.find(function (el) {
        return el.classList && el.classList.contains('ZU-radio-btn-group');
      }),
    ...
    var nr = e.path.find(function (el) {
      return el.classList && el.classList.contains('ZU-restyle-null');
    });
    if (nr) {
    ...
    var nrs = e.path.find(function (el) {
      return el.classList && el.classList.contains('ZU-nulltwk-save');
    });
    if (nrs) {
      NullRestyler.save();
    }
    ...
    var nrr = e.path.find(function (el) {
      return el.classList && el.classList.contains('ZU-nulltwk-revert');
    });
    if (nrr) {
    ...
    var shs = e.path.find(function (el) {
      return el.classList && el.classList.contains('ZU-hide-selection');
    });
    if (shs) {
      textSteganography.hideSelection(shs.findParent('.reply-form').querySelector('textarea'));
    }
    var srs = e.path.find(function (el) {
      return el.classList && el.classList.contains('ZU-remove-spoilers');
    });
    if (srs) {
    ...
    var expRef = e.path.find(function (el) {
      return el.classList && el.classList.contains('ZU-expand-refs');
    });
    if (expRef) {
  ...
  mouseenter: function mouseenter(e) {
    ...
    var peek = e.path.find(function (el) {
      return el.classList && el.classList.contains('fa-plus-square-o') && el.findParent('.post-footer');
    });
    if (peek) {
  ...
  input: function input(e) {
    ...
    var nr = e.path.find(function (el) {
      return el.classList && el.classList.contains('ZU-range');
    });
    if (nr) {
